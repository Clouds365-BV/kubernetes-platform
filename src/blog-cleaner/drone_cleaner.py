...
if __name__ == "__main__":
  ...
  if not ghost_url or not ghost_admin_api_key:
    print("Error: Missing required environment variables (GHOST_URL, GHOST_ADMIN_API_KEY)")
    sys.exit(1)

  cleaner = DroneBlogCleaner(ghost_url, ghost_admin_api_key)
  cleaner.delete_all_posts()
  print("Drone Cleaner process completed")
